...
//                       className="px-2 py-1 border border-slate-600 rounded text-sm bg-slate-800 text-white focus:outline-none focus:ring-1 focus:ring-indigo-500"
//                       autoFocus
//                       onKeyDown={(e) => {
...
//                         className="p-1 text-slate-500 hover:bg-slate-800 rounded transition"
//                       >
...
//                     className="border border-slate-700/30 rounded-lg overflow-hidden hover:border-slate-600 transition"
//                   >
...
//                       <span
//                         key={user._id}
//                         className="inline-flex items-center gap-1 px-2 py-0.5 bg-slate-900 border border-indigo-500/30 rounded-md text-xs text-indigo-300"
//                       >
...
const ChannelSettingsModal = ({
  ...
  return (
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="bg-slate-900 rounded-2xl shadow-2xl w-full max-w-lg max-h-[90vh] flex flex-col border border-slate-700/50">
        {/* Header */}
          ...
          {isEditingName ? (
            <div className="flex items-center gap-2">
              ...
              <button
                onClick={handleSaveChannelName}
                disabled={savingChannelName}
                className="p-1 text-green-500 hover:bg-slate-800 rounded transition disabled:opacity-50"
              >
                {savingChannelName ? (
            ...
            <div className="flex items-center gap-2">
              <h3 className="text-sm text-slate-300 flex-1">
                {editedChannelName || channel?.name}
              </h3>
              {isAdmin && (
                <button
        ...
        {/* Tabs */}
        <div className="px-5 pt-3 pb-2 flex gap-2 border-b border-slate-700/50">
          <button
            onClick={() => setActiveTab("members")}
            className={`flex-1 px-3 py-1.5 rounded-md text-xs font-medium transition ${
              activeTab === "members"
            ...
            <div className="space-y-3">
              <div className="relative">
                ...
                <input
                  ...
                  onChange={handleSearchInput}
                  placeholder="Search users..."
                  className="w-full pl-10 pr-4 py-2.5 bg-slate-800 border border-slate-700 rounded-xl text-sm text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-indigo-500/50"
                />
              </div>
                ...
                {isSearching ? (
                  ...
                  searchResults.map((user) => {
                    ...
                    return (
                      <div
                        key={user._id}
                        className="bg-slate-800/50 rounded-xl p-3 border border-slate-700/30 flex items-center gap-3"
                      >
                        <div className="w-10 h-10 rounded-full bg-gradient-to-br from-indigo-500 to-purple-600 flex items-center justify-center text-white font-semibold text-sm">
                          {user.first_name?.[0]}
                          {user.last_name?.[0]}
