...
export default function NotificationBell() {
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      {/* Dropdown */}
      {open && (
        <div className="absolute right-0 top-full mt-2 w-[380px] max-h-[480px] bg-zinc-900 border border-zinc-700/50 rounded-xl shadow-2xl shadow-black/60 overflow-hidden z-[100] flex flex-col">
          {/* Header */}
